...
import (
	...
	messageapi "github.com/rkhullar/python-java-scratches/src/main/go/projects/message-api/goa"
...
func main() {
	...
	{
		messageSvc = messageapi.NewMessage()
	}
	...
	{
		messageEndpoints = message.NewEndpoints(messageSvc)
		messageEndpoints.Use(debug.LogPayloads())
		messageEndpoints.Use(log.Endpoint)
	}
	...
	case "development":
		{
			...
			handleHTTPServer(ctx, u, messageEndpoints, &wg, errc, *dbgF)
		}
