...
import (
	...
	messagesvr "github.com/rkhullar/python-java-scratches/src/main/go/projects/message-api/goa/gen/http/message/server"
...
func handleHTTPServer(ctx context.Context, u *url.URL, messageEndpoints *message.Endpoints, wg *sync.WaitGroup, errc chan error, dbg bool) {
	...
	// responses.
	var (
		messageServer *messagesvr.Server
	)
	{
		eh := errorHandler(ctx)
	...
	// Configure the mux.
	messagesvr.Mount(mux, messageServer)
	...
	for _, m := range messageServer.Mounts {
